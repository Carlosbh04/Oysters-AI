  ...
  return (
    <div className="page-skeleton">
      ...
      <div className="page-skeleton__nav">
        <SkeletonPiece variant="block" height={48} />
      </div>
      ...
      <div className="page-skeleton__body">
        ...
        <div className="page-skeleton__hero">
          <div className="page-skeleton__hero-text">
            <SkeletonPiece variant="line" width="22%" />
            <SkeletonPiece variant="title" width="78%" />
            <SkeletonPiece variant="title" width="58%" />

            <div className="page-skeleton__paragraph">
              <SkeletonPiece variant="line" width="88%" />
              <SkeletonPiece variant="line" width="80%" />
              <SkeletonPiece variant="line" width="64%" />
            </div>
          ...
          <div className="page-skeleton__hero-media">
            <SkeletonPiece variant="circle" size="min(300px, 24vw)" />
          </div>
        </div>
          ...
          {[0, 1, 2, 3].map((i) => (
            <div className="page-skeleton__card" key={i}>
              <div className="page-skeleton__card-head">
                <SkeletonPiece variant="circle" size={38} />
                <SkeletonPiece variant="line" width="60%" />
              </div>

              <SkeletonPiece variant="line" width="92%" />
              <SkeletonPiece variant="line" width="84%" />
              <SkeletonPiece variant="line" width="52%" />
            </div>
          ))}
        </div>
      </div>
